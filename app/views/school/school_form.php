        ...
        <div class="container">
            ...
            <div class="db-breadcrumb">
                ...
                <ul class="db-breadcrumb-list">
                    <li>
                        <a href=""><i class="flaticon-education"></i>Manage schools</a>
                    </li>
                    <li>
                            ...
                            <form id="programForm" method="POST" enctype="multipart/form-data">
                                <div class="form-content">
                                    ...
                                    <div class="form-group">
                                        <label>Logo</label>
                                        <div>
                                        <input type="hidden" name="file-name" value="<?=$this->school->logo?>">
                                            ...
                                            <?php
                                                if($this->school->logo) {
                                                    echo '<script>(function(){'
                                                            ...
                                                            img.setAttribute("src",'.'"/SENG_SYSTEM/public/uploads/logo/'.$this->school->logo.'");
